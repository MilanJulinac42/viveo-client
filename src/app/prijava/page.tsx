/**
 * @fileoverview Login page with gradient hero and centered login form.
 *
 * @example
 * ```
 * Route: /prijava
...
export const metadata: Metadata = {
  title: "Prijava — Viveo",
  description:
    "Prijavite se na vaš Viveo nalog i pristupite personalizovanim video porukama.",
  openGraph: {
    title: "Prijava — Viveo",
    description:
      "Prijavite se na vaš Viveo nalog i pristupite personalizovanim video porukama.",
            ...
            <div className="py-16 text-center sm:py-20">
              <ScrollReveal>
                ...
                <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-primary-200">
                  Pristupite vašem Viveo nalogu i upravljajte porudžbinama
                </p>
              </ScrollReveal>
            </div>
          </Container>
