/**
 * @fileoverview Login form with email/password fields, social login buttons,
 * client-side validation, and animated success state.
 *
 * @example
 * ```tsx
 * <LoginForm />
...
/**
 * Login form component with email/password validation and mock submit.
 *
 * @returns Interactive login form with success animation
 */
    ...
    return (
      ...
      >
        ...
        <p className="mt-2 text-slate-600">
          Dobrodošli nazad na Viveo platformu.
        </p>
  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm sm:p-8">
      ...
      <div className="mb-6 text-center">
        <h2 className="text-xl font-bold text-slate-900">Dobrodošli nazad</h2>
        <p className="mt-1 text-sm text-slate-500">
          Prijavite se na vaš Viveo nalog
        </p>
      </div>
      ...
      <div className="space-y-5">
        ...
        >
          {isSubmitting ? "Prijava u toku..." : "Prijavite se"}
        </Button>
      </div>
